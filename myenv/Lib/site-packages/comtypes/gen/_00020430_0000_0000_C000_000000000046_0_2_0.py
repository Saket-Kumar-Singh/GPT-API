...
__all__ = [
    'Unchecked', 'IPictureDisp', 'Font', 'StdPicture', 'OLE_TRISTATE',
    'OLE_COLOR', 'FONTITALIC', 'Monochrome', 'OLE_YSIZE_PIXELS',
    'OLE_XPOS_CONTAINER', 'OLE_CANCELBOOL', 'OLE_YSIZE_CONTAINER',
    'IFontDisp', 'OLE_YPOS_CONTAINER', 'OLE_XPOS_HIMETRIC',
    'IPicture', 'OLE_HANDLE', 'OLE_ENABLEDEFAULTBOOL',
    'OLE_YPOS_HIMETRIC', 'FONTSTRIKETHROUGH', 'FONTNAME', 'Default',
    'OLE_YSIZE_HIMETRIC', 'Gray', 'OLE_XSIZE_HIMETRIC', 'Checked',
    'FontEvents', 'OLE_XPOS_PIXELS', 'OLE_XSIZE_CONTAINER',
    'OLE_YPOS_PIXELS', 'FONTSIZE', 'OLE_OPTEXCLUSIVE', 'VgaColor',
    'FONTBOLD', 'Picture', 'StdFont', 'IFont', 'LoadPictureConstants',
    'FONTUNDERSCORE', 'IFontEventsDisp', 'Color', 'OLE_XSIZE_PIXELS'
]

_check_version('1.2.1', 1651900738.765207)
