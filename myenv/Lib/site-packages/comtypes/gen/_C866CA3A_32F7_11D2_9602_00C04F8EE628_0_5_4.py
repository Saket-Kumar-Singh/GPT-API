...
__all__ = [
    'ISpeechAudio', 'SpeechPropertyResponseSpeed',
    'DISPID_SpeechGrammarRule', 'SSFMCreate', 'SAFT32kHz16BitMono',
    'ISpeechLexiconPronunciations', 'DISPID_SRSClsidEngine',
    'SPSVerb', 'DISPID_SABIMinNotification',
    'DISPID_SDKGetBinaryValue', 'SRCS_Disabled', 'SpeechAudioVolume',
    'DISPID_SLGenerationId', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SVSInputWordPosition', 'SPFM_NUM_MODES',
    'SpeechEngineConfidence', 'ISpeechGrammarRuleStateTransitions',
    'ISpeechGrammarRuleState', 'SREFalseRecognition',
    'DISPID_SpeechDataKey', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SVSpeak', 'SGDSActiveWithAutoPause',
    'SPINTERFERENCE_TOOFAST', 'ISpObjectTokenCategory',
    'eLEXTYPE_PRIVATE17', 'DISPID_SpeechRecognizer', 'SVP_20',
    'ISpeechRecognizerStatus', 'SVPOver', 'eLEXTYPE_PRIVATE3',
    'WAVEFORMATEX', 'DISPID_SRCAudioInInterferenceStatus', 'STCAll',
    'DISPID_SVPause', 'DISPID_SpeechRecognizerStatus',
    'SpeechGrammarWordType', 'DISPID_SDKDeleteKey',
    'ISpeechObjectTokenCategory', 'SPCONTEXTSTATE', 'SPEI_UNDEFINED',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpDataKey', 'DISPID_SOTId',
    'DISPID_SOTCId', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SPEPronunciation',
    'DISPID_SVEViseme', 'SPWORDPRONOUNCEABLE',
    'DISPID_SRRSaveToMemory', 'SAFT44kHz8BitMono', 'SP_VISEME_6',
    'DISPID_SPEsCount', 'SPXRO_SML', 'LONG_PTR', 'DISPID_SRCResume',
    'DISPID_SMSADeviceId', 'SPCT_DICTATION',
    'DISPIDSPTSI_ActiveLength', 'SAFT8kHz16BitMono',
    'DISPID_SADefaultFormat', 'SAFT11kHz16BitStereo',
    'SpeechRunState', 'SPBO_AHEAD', 'SAFTCCITT_ALaw_22kHzStereo',
    'SAFTCCITT_uLaw_8kHzMono', 'SVSFIsFilename', 'DISPID_SpeechAudio',
    'DISPID_SMSALineId', 'DISPID_SWFEExtraData',
    'SDA_Consume_Leading_Spaces', 'SpeechAudioProperties',
    'SPEI_FALSE_RECOGNITION', 'SPPS_NotOverriden',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRCreateRecoContext',
    'SSFMCreateForWrite', 'SpFileStream', 'SSFMOpenForRead',
    'SpeechInterference', 'SPPS_LMA', 'eLEXTYPE_PRIVATE18',
    'DISPID_SLWWord', 'SRESoundEnd', 'DISPID_SBSRead',
    'DISPID_SAEventHandle', 'SpShortcut', 'DISPID_SpeechMMSysAudio',
    'DISPID_SpeechRecoContextEvents', 'ISpPhraseAlt',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SVGetAudioInputs',
    'SVP_6', 'SPLOADOPTIONS', 'DISPID_SOTs_NewEnum',
    'DISPID_SpeechCustomStream', 'SECFEmulateResult',
    'SpeechDictationTopicSpelling', 'DISPID_SPPNumberOfElements',
    'SPFM_OPEN_READWRITE', 'SDA_Two_Trailing_Spaces',
    'DISPID_SGRSTsItem', 'DISPID_SpeechAudioBufferInfo',
    'SAFTADPCM_44kHzMono', 'SPEI_VISEME', 'SVF_None',
    'SPINTERFERENCE_TOOSLOW', 'SpSharedRecoContext',
    'ISpRecoGrammar2', 'SpeechDiscardType', 'SPEI_END_INPUT_STREAM',
    'DISPID_SPAs_NewEnum', 'SpeechFormatType', 'DISPID_SRRecognizer',
    'DISPID_SOTDataKey', 'DISPID_SVGetAudioOutputs', 'SBOPause',
    'SPEVENT', 'SPGS_ENABLED', 'SPFM_CREATE_ALWAYS', 'SPSHT_EMAIL',
    'ISpeechPhraseProperties',
    'SpeechPropertyNormalConfidenceThreshold',
    'IInternetSecurityManager', 'DISPID_SRGSetWordSequenceData',
    'SpMMAudioEnum', 'DISPID_SPPFirstElement', 'SRERecoOtherContext',
    'DISPID_SVSpeakCompleteEvent', 'SRAImport', 'SASStop',
    'SPEI_RESERVED5', 'DISPID_SLWPronunciations',
    'ISpeechAudioFormat', 'SpeechAudioFormatType',
    'DISPID_SRCRetainedAudio', 'DISPID_SAFSetWaveFormatEx',
    'SpObjectTokenCategory', 'DISPID_SGRSTNextState',
    'ISpeechGrammarRules', 'SVSFDefault', 'SVP_18',
    'DISPID_SPCPhoneToId', 'ISpRecognizer2', 'SLOStatic',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SVWaitUntilDone',
    'SPEI_RESERVED6', 'SVP_19', 'eLEXTYPE_PRIVATE9',
    'DISPID_SVStatus', 'ISpeechLexicon', 'DISPID_SpeechPhraseRule',
    'SAFT22kHz8BitStereo', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SLGetWords',
    'SpeechGrammarRuleStateTransitionType',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpSharedRecognizer',
    'SDKLDefaultLocation', 'SPAUDIOSTATE', 'SpeechBookmarkOptions',
    'Speech_StreamPos_Asap', 'SAFT22kHz8BitMono',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SGRsAdd',
    'SPRST_ACTIVE_ALWAYS', 'SPAO_RETAIN_AUDIO',
    'DISPID_SpeechVoiceStatus', 'DISPID_SPEDisplayText',
    'SP_VISEME_10', 'DISPID_SRRGetXMLErrorInfo', 'SpeechGrammarState',
    'SpeechAddRemoveWord', 'SpeechWordPronounceable',
    'DISPID_SpeechRecoResult2', 'ISpeechRecoResult2',
    'SPPARTOFSPEECH', 'DISPID_SVEventInterests', 'SREAllEvents',
    'DISPID_SWFEChannels', 'DISPID_SAStatus', 'SVP_2', 'SP_VISEME_1',
    'ISpeechFileStream', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SPPValue', 'DISPID_SMSSetData', 'DISPID_SABufferInfo',
    'SRATopLevel', 'DISPID_SPRuleName', 'SpeechRuleAttributes',
    'SpeechWordType', 'SPRST_INACTIVE', 'DISPID_SRGetPropertyString',
    'SpeechRecoContextState', 'SpeechRecognizerState',
    'SpeechAudioFormatGUIDWave', 'SPRECOGNIZERSTATUS',
    'DISPID_SPEDisplayAttributes', 'SPEI_SOUND_END',
    'SpeechVoicePriority', 'SPEI_RECO_OTHER_CONTEXT', 'SGSExclusive',
    'SREStateChange', 'SpeechRuleState', 'SVF_Emphasis',
    'SDTLexicalForm', 'ISpRecoGrammar', 'SFTSREngine', 'SVP_7',
    'SPBO_PAUSE', 'DISPID_SLWsItem', 'SINoise', 'ISpeechObjectToken',
    'SPWF_INPUT', 'DISPID_SRCEAdaptation', 'SAFT32kHz16BitStereo',
    'ISpeechPhraseRules', 'SPGS_DISABLED', 'SPSMF_UPS',
    'DISPID_SLPPartOfSpeech', 'DISPID_SOTGetAttribute',
    'DISPID_SPRFirstElement', 'SPGRAMMARSTATE',
    'ISpeechAudioBufferInfo', 'STCRemoteServer', 'ISpStreamFormat',
    'SpeechRegistryUserRoot', 'DISPID_SPEAudioTimeOffset',
    'SPWAVEFORMATTYPE', 'SPAR_Unknown', 'SPVISEMES',
    'DISPID_SRRRecoContext', 'DISPID_SRCState', 'SPSInterjection',
    'SPWF_SRENGINE', 'SAFT16kHz8BitMono', 'DISPID_SOTIsUISupported',
    'DISPID_SDKGetlongValue', 'SpeechStreamFileMode',
    'ISpeechPhraseReplacement', 'SVP_12', 'DISPID_SPRulesCount',
    'eLEXTYPE_PRIVATE11', 'DISPID_SLRemovePronunciation',
    'SP_VISEME_5', 'ISpRecoCategory', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SRGRecoContext', 'ISpeechLexiconWords', 'SVP_17',
    'SpeechVoiceEvents', 'DISPID_SOTRemove', 'ISpRecoContext2',
    'SPAS_STOP', 'eLEXTYPE_RESERVED8', 'DISPID_SWFEFormatTag',
    'DISPID_SpeechMemoryStream', 'SGRSTTEpsilon', 'SPEI_MIN_TTS',
    'DISPID_SPIProperties', 'DISPID_SPEAudioStreamOffset',
    'SPBO_TIME_UNITS', 'SAFT16kHz8BitStereo', 'SP_VISEME_18',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRRTStreamTime',
    'SGDSActive', 'SAFT22kHz16BitStereo', 'SRSActiveAlways',
    'SpLexicon', 'DISPID_SVSLastResult', 'DISPID_SLPLangId',
    'DISPID_SRGId', 'DISPID_SOTGetStorageFileName',
    'STSF_CommonAppData', 'DISPID_SOTRemoveStorageFileName',
    'SPBOOKMARKOPTIONS', 'IStream', 'DISPID_SWFEBlockAlign',
    'SITooQuiet', 'DISPID_SPEEngineConfidence', 'DISPID_SLPSymbolic',
    'SVP_1', 'SP_VISEME_7', 'ISpEventSource',
    'DISPID_SRSCurrentStreamPosition', 'SREInterference',
    'SAFT44kHz16BitStereo', 'DISPID_SPERequiredConfidence',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SBSSeek',
    'SGSEnabled', 'SRTEmulated', 'tagSTATSTG', 'SRERecognition',
    'SAFT12kHz8BitStereo', 'ISpStream',
    'DISPID_SRSNumberOfActiveRules', 'ISpeechPhoneConverter',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SAVolume',
    'DISPID_SpeechVoiceEvent', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SRGCmdLoadFromMemory', 'SPPS_Unknown',
    'SpeechCategoryPhoneConverters', 'SPEI_START_INPUT_STREAM',
    'SPPS_SuppressWord', 'DISPID_SGRsCount',
    'ISpeechPhraseInfoBuilder', 'DISPID_SABIEventBias', 'SPEVENTENUM',
    'DISPID_SLPsCount', 'DISPID_SPAsItem', 'DISPID_SGRs_NewEnum',
    'SPCS_DISABLED', 'SPSERIALIZEDPHRASE', 'ISpeechPhraseInfo',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SWPKnownWordPronounceable',
    'DISPID_SpeechPhraseAlternate', 'SAFT8kHz8BitMono',
    'ISpEventSink', 'SVSFlagsAsync',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SGRSTText',
    'SPRST_ACTIVE', 'SPWORDLIST', 'DISPID_SpeechPhraseElements',
    'SPDATAKEYLOCATION', 'eLEXTYPE_PRIVATE2',
    'DISPID_SVSInputSentenceLength',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechPropertyAdaptationOn', 'DISPID_SPRText',
    'DISPID_SRRPhraseInfo', 'eLEXTYPE_RESERVED10',
    'DISPID_SpeechPhraseAlternates', 'SPSUnknown',
    'DISPID_SDKGetStringValue', 'SpPhraseInfoBuilder',
    'SpeechCategoryAppLexicons', 'ISpXMLRecoResult',
    'ISpeechPhraseReplacements', 'ISpeechGrammarRule',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SRCEPhraseStart', 'SVP_9',
    'DISPID_SPRuleConfidence', 'SPAR_Medium', 'SRSInactiveWithPurge',
    'DISPID_SRGReset', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SRSetPropertyNumber', 'SPVPRI_NORMAL',
    'DISPID_SDKSetBinaryValue', 'SpeechTokenShellFolder',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SFSOpen',
    'SVEAllEvents', 'SAFT48kHz8BitMono', 'DISPID_SRGCmdLoadFromFile',
    'SpeechLoadOption', 'ISpeechGrammarRuleStateTransition',
    'ISpAudio', 'SAFTCCITT_uLaw_44kHzMono', 'SPPS_RESERVED1',
    'SPVPRIORITY', 'ISpProperties', 'SVSFParseMask',
    'tagSPPROPERTYINFO', 'SREPhraseStart', 'SAFT32kHz8BitStereo',
    'SPAS_PAUSE', 'SRERequestUI', 'DISPID_SpeechRecoContext',
    'DISPID_SpeechLexiconWords', 'SpeechDataKeyLocation',
    'SpNullPhoneConverter', 'SpeechVoiceSkipTypeSentence',
    'SpeechCategoryAudioOut', 'eWORDTYPE_ADDED',
    'SGDSActiveUserDelimited', 'DISPID_SpeechPhraseReplacements',
    'SPCT_SLEEP', 'SPLEXICONTYPE', 'SPWORD', 'SGRSTTWord',
    'SPDKL_CurrentConfig', 'DISPID_SRRSetTextFeedback',
    'DISPID_SRCRetainedAudioFormat', 'SpAudioFormat',
    'SPXRO_Alternates_SML', 'DISPID_SRCERequestUI',
    'DISPID_SRCERecognizerStateChange', 'ISpeechDataKey',
    'DISPID_SOTsItem', 'SRAExport', 'SREPropertyStringChange',
    'eLEXTYPE_RESERVED6', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SAFT11kHz16BitMono', 'DISPID_SDKDeleteValue',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRSetPropertyString',
    'SpPhoneConverter', 'DISPID_SpeechRecoResult', 'SP_VISEME_12',
    'IEnumString', 'DISPID_SGRsDynamic', 'DISPID_SPELexicalForm',
    'SpeechVisemeFeature', 'DISPID_SPEsItem', 'DISPID_SRRAudioFormat',
    'eLEXTYPE_PRIVATE8', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SREStreamEnd',
    'SPFM_OPEN_READONLY', 'DISPID_SVEAudioLevel',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SAFType',
    'DISPID_SPPName', 'SVEAudioLevel', 'SGDisplay',
    'SpeechAllElements', 'DISPID_SPILanguageId',
    'DISPID_SpeechPhraseRules', 'SREBookmark', 'SRSActive',
    'DISPID_SRRGetXMLResult', 'SREAdaptation', 'ISpPhoneConverter',
    'SVPAlert', 'Speech_StreamPos_RealTime', 'DISPID_SPRules_NewEnum',
    'SpStream', 'DISPID_SWFESamplesPerSec', 'ISpeechPhraseRule',
    'SpPhoneticAlphabetConverter', 'SECHighConfidence',
    'SPWORDPRONUNCIATION', 'SpeechTokenValueCLSID',
    'DISPID_SVESentenceBoundary', 'DISPID_SMSAMMHandle',
    'Speech_Max_Word_Length', 'DISPID_SRRAudio',
    'ISpeechResourceLoader', 'SPWT_DISPLAY', 'SPRS_ACTIVE',
    'DISPID_SBSWrite', 'DISPID_SDKSetLongValue',
    'DISPID_SWFEBitsPerSample', 'ISpShortcut',
    'DISPID_SpeechFileStream', 'eLEXTYPE_PRIVATE14', 'SDTRule',
    'DISPID_SOTCSetId', 'SVP_15', 'ISpRecoContext',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPIGrammarId',
    'DISPID_SpeechVoice', 'DISPID_SPPEngineConfidence',
    'SREAudioLevel', 'DISPID_SWFEAvgBytesPerSec',
    'SRTExtendableParse', 'DISPID_SRCEStartStream',
    'SAFT24kHz16BitMono', 'DISPID_SVVoice', 'SpeechVoiceSpeakFlags',
    'SpUnCompressedLexicon', 'SRSInactive', 'SPINTERFERENCE_NONE',
    'SAFTNonStandardFormat', 'SP_VISEME_0',
    'DISPID_SpeechLexiconWord', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SAFT12kHz16BitStereo', 'SPSEMANTICERRORINFO', 'DISPID_SLPsItem',
    'SAFT48kHz16BitStereo', 'SAFTADPCM_11kHzMono', 'DISPID_SLWsCount',
    'DISPID_SRRAlternates', 'IInternetSecurityMgrSite',
    'DISPID_SRCPause', 'SDKLCurrentUser', 'SPAO_NONE', 'SpMMAudioIn',
    'DISPID_SABufferNotifySize', 'SpeechRecoEvents', 'DISPIDSPRG',
    'ISpeechXMLRecoResult', 'SpVoice', 'DISPID_SLWLangId',
    'SpeechPartOfSpeech', 'ISpeechRecoResult', 'SSTTWildcard',
    'SECFNoSpecialChars', 'SPEI_REQUEST_UI',
    'DISPID_SRCEPropertyStringChange', 'SPDKL_CurrentUser',
    'DISPID_SPIGetDisplayAttributes', 'SPPHRASERULE',
    'SAFT16kHz16BitStereo', 'DISPID_SpeechObjectToken',
    'DISPID_SPIGetText', 'SDTPronunciation', 'SpeechCategoryAudioIn',
    'SP_VISEME_15', 'DISPID_SAFGuid', 'SPSHT_Unknown',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SOTsCount',
    'DISPIDSPTSI_SelectionLength', 'SRSEDone',
    'DISPID_SVEVoiceChange', 'SPVPRI_ALERT', 'DISPID_SGRSRule',
    'ISpPhrase', 'ISpStreamFormatConverter', 'DISPID_SPAPhraseInfo',
    'SREHypothesis', 'ISpResourceManager', 'SGPronounciation',
    'ISpeechPhraseElements', 'SPWT_PRONUNCIATION',
    'SAFT48kHz16BitMono', 'SPVOICESTATUS', 'SPPS_Verb',
    'DISPID_SVSpeakStream', 'SSSPTRelativeToStart', 'SVF_Stressed',
    'SITooSlow', 'SpWaveFormatEx', 'DISPID_SRProfile',
    'DISPID_SRGRules', 'SWPUnknownWordPronounceable',
    'DISPID_SRGState', 'SPRULESTATE', 'SBONone',
    'DISPID_SRCEPropertyNumberChange', 'SAFT24kHz8BitMono',
    'DISPID_SRGCmdLoadFromResource',
    'DISPID_SVSInputSentencePosition', 'SVP_5', 'DISPID_SPRuleId',
    'DISPID_SVRate', 'DISPID_SABIBufferSize', 'DISPID_SPCIdToPhone',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SGRSTs_NewEnum',
    'SAFTCCITT_uLaw_22kHzMono', 'SAFTCCITT_uLaw_11kHzStereo',
    'ISpeechVoice', 'SAFTGSM610_11kHzMono', 'DISPID_SRIsUISupported',
    'SGRSTTDictation', 'ISpVoice', 'SpeechEmulationCompareFlags',
    'SVSFPurgeBeforeSpeak', 'SPEI_TTS_BOOKMARK', 'eLEXTYPE_RESERVED7',
    'DISPID_SRGCommit', 'ISpeechMMSysAudio', 'SPLO_STATIC',
    'SpeechTokenKeyFiles', '_ISpeechRecoContextEvents', 'SINoSignal',
    'SGDSInactive', 'SPEI_MAX_TTS', 'tagSPTEXTSELECTIONINFO',
    'eWORDTYPE_DELETED', 'SpeechCategoryVoices', 'SP_VISEME_3',
    'DISPID_SASetState', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT48kHz8BitStereo', 'DISPID_SRCERecognition',
    'SAFTGSM610_8kHzMono', 'SPEI_RECO_STATE_CHANGE', 'SINone',
    'SPPHRASEPROPERTY', 'SAFT22kHz16BitMono', 'DISPID_SGRClear',
    'DISPID_SPPs_NewEnum', 'ISpeechBaseStream', 'SITooFast',
    'SpeechDisplayAttributes', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_MAX_SR', 'SPPS_Modifier', 'SP_VISEME_14',
    'DISPID_SPIAudioSizeTime', 'SDTAll', 'SPEI_RESERVED3',
    'ISpeechCustomStream', 'ISpPhoneticAlphabetSelection',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFTADPCM_8kHzStereo',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRGetFormat',
    'SpeechRecoProfileProperties', 'SPRULE', '_SPAUDIOSTATE',
    'DISPID_SpeechPhraseElement', 'SpCompressedLexicon',
    'DISPID_SVAlertBoundary', 'DISPID_SRCBookmark', 'SRTAutopause',
    'DISPID_SPRuleParent', 'SPINTERFERENCE', 'ISpeechObjectTokens',
    'SREPropertyNumChange', 'SVEPrivate', 'SGLexical',
    'SpeechCategoryRecognizers', 'DISPID_SASFreeBufferSpace',
    'DISPID_SPPsCount', 'SLTUser', 'DISPID_SVGetVoices',
    'DISPID_SRCEBookmark', 'SVP_11', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRCCmdMaxAlternates', 'eLEXTYPE_PRIVATE16',
    'DISPID_SRRTOffsetFromStart', 'SPGS_EXCLUSIVE', 'SDTDisplayText',
    'ISpSerializeState', 'DISPID_SpeechWaveFormatEx',
    'SPRST_NUM_STATES', 'DISPID_SGRSAddRuleTransition',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPEI_WORD_BOUNDARY',
    'SPAUDIOSTATUS', 'SPFILEMODE', 'DISPID_SASCurrentDevicePosition',
    'SVEBookmark', 'SPSNoun', 'ISpNotifySource', 'SWTDeleted',
    'SAFT12kHz16BitMono', 'SP_VISEME_17',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SVVolume',
    'DISPID_SpeechAudioStatus', 'SpeechEngineProperties',
    'SECNormalConfidence', 'ISpeechPhraseAlternate',
    'DISPID_SpeechPhraseProperty', 'DISPID_SASState',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRGDictationLoad',
    'DISPID_SOTSetId', 'DISPID_SDKEnumValues', 'SP_VISEME_13',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SPIEnginePrivateData',
    'SVEPhoneme', 'DISPID_SVSLastBookmarkId',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SGRName', 'SVP_8',
    'SpeechGrammarTagDictation', 'DISPID_SVAudioOutput',
    'DISPID_SRGDictationSetState', 'eLEXTYPE_APP',
    'ISpGrammarBuilder', 'DISPID_SVDisplayUI', 'SAFT44kHz16BitMono',
    'SVSFParseSsml', 'SVSFVoiceMask', 'SPSModifier',
    'ISpeechLexiconPronunciation', 'SpeechPropertyResourceUsage',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SRDisplayUI', 'DISPID_SPEAudioSizeTime',
    'SPAUDIOBUFFERINFO', 'DISPID_SRGDictationUnload',
    'SVSFNLPSpeakPunc', 'SVP_21', 'SAFTText', 'DISPID_SPIEngineId',
    'DISPID_SRCEEnginePrivate', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SLWs_NewEnum', 'DISPID_SOTCDefault',
    'SWPUnknownWordUnpronounceable', 'SDTProperty',
    'SAFTCCITT_ALaw_8kHzMono', 'ISpeechAudioStatus',
    'SAFTADPCM_22kHzStereo', 'SPEI_HYPOTHESIS', 'STSF_LocalAppData',
    'DISPID_SLAddPronunciationByPhoneIds', 'eLEXTYPE_PRIVATE6',
    'SAFT11kHz8BitMono', 'DISPID_SCSBaseStream', 'SPCS_ENABLED',
    'ISpRecognizer3', 'SVSFIsNotXML', 'SPAS_CLOSED',
    'SPEI_SR_RETAINEDAUDIO', 'SPEI_INTERFERENCE', 'DISPID_SPACommit',
    'ISpRecoResult', 'SPWORDTYPE', 'SpeechTokenIdUserLexicon',
    'ISpRecognizer', 'SP_VISEME_20', 'DISPID_SRCEInterference',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRStatus',
    'Speech_Max_Pron_Length', 'SPSHORTCUTPAIRLIST',
    'DISPID_SVSLastBookmark', 'eLEXTYPE_USER', 'SVPNormal',
    'DISPID_SVGetProfiles', '__MIDL_IWinTypes_0009',
    'SPEI_SOUND_START', 'Speech_Default_Weight',
    'DISPID_SDKSetStringValue', 'DISPID_SPRDisplayAttributes',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRAudioInputStream',
    'DISPID_SGRSTPropertyId', 'DISPID_SpeechLexiconPronunciation',
    'SpeechUserTraining', 'SGLexicalNoSpecialChars', 'SP_VISEME_19',
    'SECFIgnoreCase', 'SpeechGrammarTagUnlimitedDictation',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SPIElements',
    'SpTextSelectionInformation', 'SSFMOpenReadWrite',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SOTCategory',
    'DISPID_SVEStreamEnd', 'DISPID_SPIAudioSizeBytes',
    'SPPS_Noncontent', 'DISPID_SRGSetTextSelection',
    'DISPID_SPRsItem', 'DISPID_SPCLangId', 'SAFT44kHz8BitStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SVP_3', 'SVP_16',
    'ISpNotifySink', 'SECFIgnoreKanaType', 'SPDKL_LocalMachine',
    'DISPID_SRSSupportedLanguages', 'DISPID_SPIReplacements',
    'SGRSTTRule', 'DISPID_SRCEFalseRecognition', 'SVP_4',
    'DISPID_SPPsItem', 'SAFTTrueSpeech_8kHz1BitMono', 'SPPS_Noun',
    'DISPID_SGRInitialState', 'ISpeechLexiconWord',
    'eLEXTYPE_PRIVATE19', 'SPPROPERTYINFO',
    'ISpPhoneticAlphabetConverter', 'SpeechAudioFormatGUIDText',
    'SAFTADPCM_44kHzStereo', 'SPPHRASEREPLACEMENT', 'SVEVoiceChange',
    'SPRS_INACTIVE', 'SPWT_LEXICAL', 'DISPID_SRGetRecognizers',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRCEAudioLevel',
    'SpeechVoiceCategoryTTSRate', 'SAFT16kHz16BitMono',
    'SAFT12kHz8BitMono', 'SDTReplacement', 'DISPID_SRCVoice',
    'SpeechTokenKeyAttributes', 'SPSHT_OTHER', 'ISpeechMemoryStream',
    'SPSLMA', 'DISPID_SpeechXMLRecoResult', 'DISPID_SOTCGetDataKey',
    'DISPID_SLGetPronunciations', 'DISPID_SVSkip',
    'DISPID_SRAudioInput', 'SpResourceManager',
    'ISpeechTextSelectionInformation', 'SGSDisabled', 'DISPIDSPTSI',
    'SPFM_CREATE', 'DISPID_SpeechGrammarRules', 'SPEI_SR_AUDIO_LEVEL',
    'SPLO_DYNAMIC', 'ISequentialStream', 'SPRECORESULTTIMES',
    'DISPID_SVSRunningState', 'DISPID_SVAudioOutputStream',
    'SPEI_VOICE_CHANGE', 'DISPID_SPAsCount', 'SpInProcRecoContext',
    'SpMMAudioOut', 'SPEI_PHONEME', 'eLEXTYPE_PRIVATE12',
    'SpeechMicTraining', 'SRTReSent', 'SRAONone', 'SRAORetainAudio',
    'DISPID_SPISaveToMemory', 'SPPS_Interjection', 'SPPS_Function',
    'ISpNotifyTranslator', 'SPINTERFERENCE_NOISE', 'SITooLoud',
    'ISpeechPhraseElement', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SPRs_NewEnum', 'SPSMF_SAPI_PROPERTIES', 'SP_VISEME_16',
    'DISPID_SRCRecognizer', 'ISpeechPhraseProperty', 'SDTAlternates',
    'DISPID_SPRuleChildren', 'ISpeechRecoResultDispatch',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPSERIALIZEDRESULT',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRRTimes',
    'SpeechStreamSeekPositionType', 'DISPID_SGRsCommit',
    'SPCT_COMMAND', 'SAFT11kHz8BitStereo', 'DISPID_SPRulesItem',
    'DISPID_SVEWord', 'SAFTCCITT_ALaw_22kHzMono', 'SVP_14',
    'DISPID_SLPs_NewEnum', 'SVSFParseAutodetect', 'SPEI_PHRASE_START',
    'eLEXTYPE_PRIVATE13', 'SECFDefault', 'SPBINARYGRAMMAR',
    'DISPID_SRRTTickCount', 'SpMemoryStream', 'SPPS_RESERVED3',
    'SPEI_MIN_SR', 'DISPID_SRCCreateGrammar', 'eLEXTYPE_PRIVATE15',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPRuleFirstElement',
    'SPADAPTATIONRELEVANCE', 'SPRST_INACTIVE_WITH_PURGE',
    'SVSFParseSapi', 'DISPID_SDKEnumKeys', 'SPTEXTSELECTIONINFO',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SGRSTWeight',
    'DISPID_SOTDisplayUI', 'DISPID_SPPId', 'DISPID_SLPPhoneIds',
    'SRADynamic', 'SSTTDictation', 'eLEXTYPE_MORPHOLOGY', 'SRARoot',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFT24kHz16BitStereo',
    'ISpObjectWithToken', 'SVP_13', 'SVSFPersistXML',
    'SDA_No_Trailing_Space', 'SPPS_RESERVED2',
    'DISPID_SRCSetAdaptationData', 'DISPID_SGRAttributes',
    'ISpeechRecognizer', 'SPEI_RESERVED2',
    'DISPID_SGRSAddWordTransition', 'DISPID_SLGetGenerationChange',
    'ISpLexicon', 'eLEXTYPE_PRIVATE4', 'DISPID_SRRSpeakAudio',
    'SPSNotOverriden', 'SPSHT_NotOverriden',
    'DISPID_SpeechAudioFormat', 'DISPID_SpeechBaseStream', 'SVP_0',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SPRsCount', 'SpeechTokenContext',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpeechRecoGrammar',
    'DISPID_SVPriority', 'DISPID_SREmulateRecognition',
    'DISPID_SpeechPhraseReplacement', 'STSF_AppData',
    'DISPID_SVSPhonemeId', 'SRCS_Enabled', 'DISPID_SRCEventInterests',
    'DISPID_SVIsUISupported', 'SAFTGSM610_44kHzMono',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechRetainedAudioOptions',
    'eLEXTYPE_PRIVATE10', 'SP_VISEME_4', 'SP_VISEME_9',
    'SSSPTRelativeToEnd', 'DISPID_SMSGetData', 'SGRSTTTextBuffer',
    'SpStreamFormatConverter', 'SPEI_TTS_PRIVATE', 'SP_VISEME_21',
    'DISPID_SRGIsPronounceable', 'DISPID_SOTCEnumerateTokens',
    'SLODynamic', 'SAFT24kHz8BitStereo', 'DISPID_SLPType', 'SPAS_RUN',
    'SVEEndInputStream', 'SFTInput', 'DISPID_SPPChildren',
    'SVSFIsXML', '_ISpeechVoiceEvents', 'ISpMMSysAudio',
    'SPPS_RESERVED4', 'DISPID_SPAStartElementInResult', 'SP_VISEME_2',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SOTGetDescription', 'DISPID_SPPParent',
    'DISPID_SGRSTransitions', 'SPEI_END_SR_STREAM', 'SpObjectToken',
    'SVEStartInputStream', 'SPAR_Low', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SpeechLexiconProns', 'ISpeechWaveFormatEx',
    'ISpObjectToken', 'IEnumSpObjectTokens', 'SASClosed',
    'SAFTGSM610_22kHzMono', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SGRId', 'SREPrivate', 'SAFTExtendedAudioFormat',
    'DISPID_SOTCreateInstance', 'DISPID_SFSClose', 'SDTAudio',
    'eLEXTYPE_PRIVATE5', 'SLTApp', 'DISPID_SDKCreateKey',
    'eLEXTYPE_RESERVED9', 'SECLowConfidence', 'SPEI_ADAPTATION',
    'SVSFNLPMask', 'DISPID_SPEActualConfidence', 'SPRECOSTATE',
    'SpeechVisemeType', 'SPINTERFERENCE_LATENCY_WARNING',
    'ISpeechRecoResultTimes', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SVEPhoneme', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SGRAddResource', 'SPCT_SUB_DICTATION', 'SAFTDefault',
    'SECFIgnoreWidth', 'SPEI_RECOGNITION', 'SVEViseme',
    'DISPID_SPPConfidence', 'SGRSTTWildcard', 'DISPID_SpeechLexicon',
    'SpeechGrammarTagWildcard', '_RemotableHandle', 'SpCustomStream',
    'SAFTADPCM_8kHzMono', 'SWTAdded', 'STCInprocHandler',
    'SpeechLexiconType', 'SPSHORTCUTTYPE', 'SAFT32kHz8BitMono',
    'DISPID_SpeechPhraseBuilder', 'SAFT8kHz16BitStereo',
    'DISPID_SGRSTPropertyValue', 'SDKLLocalMachine', 'SPVPRI_OVER',
    'SRTStandard', 'DISPID_SRCESoundStart', 'DISPID_SGRSTRule',
    'SVEWordBoundary', 'SPSHORTCUTPAIR', 'DISPID_SBSFormat',
    'SPPHRASE', 'DISPID_SASNonBlockingIO', 'DISPID_SRRTLength',
    'DISPID_SGRAddState', 'DISPID_SVSVisemeId',
    'SPEI_START_SR_STREAM', 'DISPID_SRCRequestedUIType',
    'SpeechSpecialTransitionType', 'eLEXTYPE_LETTERTOSOUND',
    'SPEVENTSOURCEINFO', 'STSF_FlagCreate', 'DISPID_SVResume',
    'SAFT8kHz8BitStereo', 'SPAR_High', 'SPSFunction',
    'ISpeechPhraseAlternates', 'DISPID_SRIsShared', 'SRAInterpreter',
    'SREStreamStart', 'SAFTNoAssignedFormat', 'SSTTTextBuffer',
    'SPSTREAMFORMATTYPE', 'eLEXTYPE_RESERVED4',
    'DISPID_SRSAudioStatus', 'SpeechRecognitionType',
    'SpNotifyTranslator', 'DISPID_SRCEEndStream', 'SPEI_SR_PRIVATE',
    'SPAUDIOOPTIONS', 'SVP_10', 'STCInprocServer',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRState',
    'DISPID_SPIStartTime', 'SPCT_SUB_COMMAND', 'UINT_PTR',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SVEBookmark',
    'ISpeechRecoContext', 'DISPID_SPIRetainedSizeBytes', 'SASRun',
    'SVSFUnusedFlags', 'eLEXTYPE_PRIVATE1', 'SPEI_RESERVED1',
    'SPCATEGORYTYPE', 'SPEI_SR_BOOKMARK', 'DISPID_SVEStreamStart',
    'SpeechCategoryRecoProfiles', 'ISpeechVoiceStatus',
    'SAFTADPCM_22kHzMono', 'DISPID_SGRSTPropertyName',
    'DISPID_SGRsItem', 'DISPID_SpeechPhraseInfo',
    'SRADefaultToActive', 'SRSEIsSpeaking', 'SPINTERFERENCE_TOOLOUD',
    'SP_VISEME_11', 'DISPID_SPIRule', 'DISPID_SPRNumberOfElements',
    'DISPID_SLWType', 'DISPID_SDKOpenKey', 'SpInprocRecognizer',
    'eLEXTYPE_PRIVATE20', 'SAFTADPCM_11kHzStereo',
    'DISPID_SRCEHypothesis', 'eLEXTYPE_PRIVATE7', 'SpeechTokenKeyUI',
    'SPSSuppressWord', 'SPSEMANTICFORMAT', 'SRTSMLTimeout',
    'DISPID_SLAddPronunciation', 'SPPHRASEELEMENT',
    'SDA_One_Trailing_Space', 'DISPID_SGRSTType',
    'DISPID_SPEs_NewEnum', 'SPGRAMMARWORDTYPE',
    'DISPID_SpeechObjectTokens', 'DISPID_SVSInputWordLength',
    'DISPID_SVEEnginePrivate', 'SPDKL_DefaultLocation',
    'SpeechAudioState', 'SRESoundStart',
    'DISPID_SVSyncronousSpeakTimeout', 'SP_VISEME_8',
    'DISPID_SAFGetWaveFormatEx', 'SDKLCurrentConfig', 'SPBO_NONE',
    'DISPID_SGRSTsCount', 'DISPID_SGRsFindRule',
    'DISPID_SRCESoundEnd', 'STCLocalServer', 'SPXMLRESULTOPTIONS',
    'DISPID_SGRsCommitAndSave', 'SASPause', 'DISPID_SPARecoResult',
    'SVESentenceBoundary'
]

_check_version('1.2.1', 1700054645.374689)
